...
\begin{flushleft}
	...
	\textls[-50]{\mono{
		...
		\hspace*{0.2in}$\bullet$ a bond between alice and bob is secure when it is mutual, bi-directional and requires both alice's and bob's approval
	...
	\textls[-50]{\mono{
		...
		\hspace*{0.2in}$\bullet$ A trivial application of a hook is a payment router, i.e. payment sent to \tcbox{0} hook \tcbox{\textcolor{purple}{-}label\textcolor{purple}{\textcolor{purple}{\#}}0.} is routed to the address of \tcbox{bob.}; more on hooks in upcoming sections.
...
\begin{flushleft}
	\textbf{\large\pbold{}}\linebreak
	\textls[-50]{\mono{
		The \tcbox{molecule} structure is the topological superset of [\tcbox{name}, \tcbox{bond}, \tcbox{molecule}, \tcbox{polycule}], i.e. it is possible to derive polycules and bonds from molecules although that'll literally be a gas-guzzling mistake. The seemingly unnecessary differentiation between the three is to optimise gas consumption.\linebreak\linebreak
		}}\linebreak\linebreak\linebreak
...
\begin{flushleft}
	...
	\textls[-50]{\mono{
		...
		\textbf{\Large\pbold{REMARKS}}\linebreak\linebreak
		\textls[-50]{\mono{Give me \$\$\$}}
	}}
\end{flushleft}
\begin{multicols}{2}
